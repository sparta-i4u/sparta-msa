...
public class GatewayConfig {
    ...
    // ✅ 공통 필터 적용 메서드 (JWT 인증 필터 + 서비스별 Rate Limiter)
    private GatewayFilterSpec applyFilters(GatewayFilterSpec f, int replenishRate, int burstCapacity) {
