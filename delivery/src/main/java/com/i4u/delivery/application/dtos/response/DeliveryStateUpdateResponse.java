...
@Builder
@AllArgsConstructor
public class DeliveryStateUpdateResponse {
	...
	public static DeliveryStateUpdateResponse fromDelivery(Delivery delivery) {
		return DeliveryStateUpdateResponse.builder()
